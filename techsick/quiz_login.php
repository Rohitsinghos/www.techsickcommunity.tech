...
<head>
  ...
  <meta name="keywords" content="Quiz Login - techsick community">
...
<div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Login is Compulsory for Quizes</h1>
      <div class="mb-4">
        <label class="block text-grey-darker text-sm font-bold mb-2" for="username">
          Username
        </label>
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" name="ans2" type="text" value="<?php echo($a); ?>">
      </div>
    ...
    <button class="inline-flex items-center bg-green-500 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Continue
