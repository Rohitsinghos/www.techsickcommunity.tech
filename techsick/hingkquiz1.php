...
const questions = [
		{		question: 'भारत में राष्टीय पोषण संस्थान कहाँ स्थित है? ',
				answers: [
					{text: 'कलकत्ता ', correct: false },
					{text: 'दिल्ली ', correct: false },
					{text: 'हैदराबाद ', correct: true },
					{text: 'रायपुर ', correct: false }
				]

		},
		{		question: 'दूसरे विश्व युद्ध के समय बंगाल में भयंकर अकाल कब आया था ',
				answers: [
		...
		{		question: 'देश में सड़कों की लंबाई की दृष्टी से कौन सा राज्य प्रथम स्थान पर है ',
				answers: [
					{text: 'दिल्ली ', correct: false },
		...
		{		question: 'राजस्थान में कहां तेल का विशाल भंडार है ',
				answers: [
					{text: 'उदयपुर ', correct: false },
					{text: 'बाड़मेर ', correct: true },
					{text: 'जोधपुर ', correct: false },
					{text: 'जैसलमेर ', correct: false }
				]

		},
		{		question: '2011 की जनगणना के अनुसार भारत में प्रति वर्ग किलोमीटर जनसंख्या का घनत्व कितना है? ',
				answers: [
		...
		{		question: 'विश्व व्यापार संगठन का मुख्यालय कहा है? ',
				answers: [
					{text: 'न्युयार्क ', correct: false },
					{text: 'वाशिंग्टन ', correct: false },
					{text: 'पेरिस ', correct: false },
					{text: 'जिनेवा ', correct: true }
				]

		},
		{		question: 'हरा सोना है - ',
				answers: [
		...
		{		question: 'हॉलमार्क चिन्ह का उपयोग किसके लिए किया जाता है? ',
				answers: [
					{text: 'आभूषण ', correct: true },
					{text: 'कृषि उत्पाद ', correct: false },
					{text: 'बिजली समान ', correct: false },
					{text: 'दुग्ध उत्पाद ', correct: false }
				]

		},
		{		question: 'श्रम विभाजन से क्या आशय है ',
				answers: [
					{text: 'आर्थिक क्रियाओं का विशेषीकरण ', correct: true },
					{text: 'उत्पादन में वृद्धि ', correct: false },
					{text: 'बड़े पैमाने पर उत्पादन ', correct: true },
					{text: 'कोई नहीं ', correct: false }
				]

		},
		{question: 'भूमि पर लगने वाला कर भारत मे किस प्रकार का कर है? ',
				answers: [
					{text: 'बिक्री कर ', correct: false },
					{text: 'प्रत्यक्ष कर ', correct: true },
					{text: 'अप्रत्यक्ष कर ', correct: false },
					{text: 'कोई नहीं ', correct: false }
				]

		},
    	{question :' वर्तमान ईराक का प्राचीन नाम था ',
				answers: [
					{text: 'यूथोपिया ', correct: false },
					{text: 'बेबीलोन ', correct: true },
					{text: 'टिक्की ', correct: true },
					{text: 'कोई नहीं ', correct: false }
				]

		},
		{		question: 'वास्कोडिगामा  ने भारत को खोजने की अपनी यात्रा कब प्रारम्भ की? ',
				answers: [
					{text: '1647', correct: false },
					{text: '1498', correct: false },
					{text: '1486', correct: false },
					{text: '1497', correct: true }
				]
