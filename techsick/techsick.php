...
<head>
  ...
  <meta name="keywords" content="Meaning of techsick - TechSick Community">
...
<section class="text-gray-600 body-font">
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">What is the meansing of techsick??</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Basically it means - "the person or any which is sick for technology.". And For us this means could be "A person or any which is very interested in Technology" ;)......
        so we choosen this word <b><u><a href =  
"../techsick/home.php?data=<?=$a?>">"Techsick"</a></u></b> for our Community. And it could be one reason, most of us are "Engineers" So I think. for us None of words will match.! </p>
    </div>
  </div>
  </form>
</section>
